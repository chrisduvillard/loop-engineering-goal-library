...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the PRD / Spec Compliance profile` |
| Codex CLI / IDE | `$shape-goal Use the PRD / Spec Compliance profile` |
