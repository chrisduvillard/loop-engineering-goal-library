...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Next Milestone profile` |
| Codex CLI / IDE | `$shape-goal Use the Next Milestone profile` |
