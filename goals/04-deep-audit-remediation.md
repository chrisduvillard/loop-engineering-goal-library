...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Deep Audit + Remediation profile` |
| Codex CLI / IDE | `$shape-goal Use the Deep Audit + Remediation profile` |
