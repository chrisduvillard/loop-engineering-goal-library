...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Safe Refactor / Modernization profile` |
| Codex CLI / IDE | `$shape-goal Use the Safe Refactor / Modernization profile` |
