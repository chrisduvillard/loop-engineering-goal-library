...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Release Readiness profile` |
| Codex CLI / IDE | `$shape-goal Use the Release Readiness profile` |
