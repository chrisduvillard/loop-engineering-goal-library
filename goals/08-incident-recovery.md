...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Incident Recovery / Stabilization profile` |
| Codex CLI / IDE | `$shape-goal Use the Incident Recovery / Stabilization profile` |
