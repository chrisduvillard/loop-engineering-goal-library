...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Dependency / Framework Upgrade profile` |
| Codex CLI / IDE | `$shape-goal Use the Dependency / Framework Upgrade profile` |
