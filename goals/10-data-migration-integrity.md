...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Data Migration / Integrity profile` |
| Codex CLI / IDE | `$shape-goal Use the Data Migration / Integrity profile` |
