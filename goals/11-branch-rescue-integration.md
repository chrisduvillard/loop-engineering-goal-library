...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Branch Rescue / Integration profile` |
| Codex CLI / IDE | `$shape-goal Use the Branch Rescue / Integration profile` |
