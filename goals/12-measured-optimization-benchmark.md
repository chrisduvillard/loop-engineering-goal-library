...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Measured Optimization / Benchmark profile` |
| Codex CLI / IDE | `$shape-goal Use the Measured Optimization / Benchmark profile` |
