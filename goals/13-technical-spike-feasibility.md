...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Technical Spike / Feasibility profile` |
| Codex CLI / IDE | `$shape-goal Use the Technical Spike / Feasibility profile` |
