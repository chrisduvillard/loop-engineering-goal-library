...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Documentation Synchronization / Knowledge Transfer profile` |
| Codex CLI / IDE | `$shape-goal Use the Documentation Synchronization / Knowledge Transfer profile` |
