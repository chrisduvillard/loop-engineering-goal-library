...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Security / Privacy Hardening profile` |
| Codex CLI / IDE | `$shape-goal Use the Security / Privacy Hardening profile` |
