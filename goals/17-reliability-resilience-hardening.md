...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Reliability / Resilience Hardening profile` |
| Codex CLI / IDE | `$shape-goal Use the Reliability / Resilience Hardening profile` |
