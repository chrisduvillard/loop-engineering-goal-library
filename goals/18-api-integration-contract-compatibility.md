...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the API / Integration Contract Compatibility profile` |
| Codex CLI / IDE | `$shape-goal Use the API / Integration Contract Compatibility profile` |
