...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Observability / Operability profile` |
| Codex CLI / IDE | `$shape-goal Use the Observability / Operability profile` |
