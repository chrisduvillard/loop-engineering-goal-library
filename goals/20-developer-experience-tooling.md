...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Developer Experience / Tooling profile` |
| Codex CLI / IDE | `$shape-goal Use the Developer Experience / Tooling profile` |
