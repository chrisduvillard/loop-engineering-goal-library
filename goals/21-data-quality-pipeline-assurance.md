...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Data Quality / Pipeline Assurance profile` |
| Codex CLI / IDE | `$shape-goal Use the Data Quality / Pipeline Assurance profile` |
