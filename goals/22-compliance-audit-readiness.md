...
| Host | Command |
|---|---|
| Claude Code | `/shape-goal Use the Compliance / Audit Readiness profile` |
| Codex CLI / IDE | `$shape-goal Use the Compliance / Audit Readiness profile` |
