...
- Latest shaping round: [ROUND ID]
- New shaping round required: Yes / No — [REASON]
...
- [BLOCKER / APPROVAL / DEFERRED DECISION] — [OWNER / SOURCE QUESTION / DEPENDENCY]

## Next action

[ONE HIGHEST-PRIORITY DEPENDENCY-SAFE UNBLOCKED ACTION, OR RETURN TO SHAPE-GOAL FOR ANOTHER ROUND]
